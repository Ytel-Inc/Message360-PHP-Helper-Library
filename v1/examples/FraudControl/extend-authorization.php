...
try 
{
	 # Extend Authorization
	  $extend_authorize = $Message360->create('FraudControl','extentAuthorizeAPIS', array(
	...
	# Print content of the extend_authorize object
	 echo "<pre>";
	 print_r($extend_authorize->getResponse());
} 
